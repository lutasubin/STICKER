...
class TranslationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'permission_videos_required': 'Video access permission is required.',
      'error_load_videos': 'Load videos failed',
      'error_cannot_read_video': 'Cannot read video.',
      'no_videos_found': 'No videos found',
      'no_videos_hint': 'Only videos up to 30 seconds are shown',
      'crop_video_title': 'Crop video',
      ...
      'optimizing_file': 'Optimizing file...',
    ...
    'vi_VN': {
      ...
      // Animated Sticker - Video
      'select_video_title': 'Chọn video',
      'permission_videos_required': 'Cần quyền truy cập video.',
      'error_load_videos': 'Tải video thất bại',
      'error_cannot_read_video': 'Không đọc được video.',
      'no_videos_found': 'Không tìm thấy video',
      'no_videos_hint': 'Chỉ hiển thị video dưới 30 giây',
      'crop_video_title': 'Cắt video',
      'crop_shape': 'Hình dạng',
      'square': 'Vuông',
      'circle': 'Tròn',
      'duration': 'Thời lượng',
      'start': 'Bắt đầu',
      'end': 'Kết thúc',
      'animated_duration_hint': 'WhatsApp hỗ trợ animated sticker 1-5 giây',
      'animated_duration_too_short': 'Thời lượng quá ngắn (tối thiểu 1s)',
      'animated_duration_too_long': 'Thời lượng quá dài (tối đa 5s)',
      'next': 'Tiếp',
      'processing_video': 'Đang xử lý video...',
      'preparing_video': 'Đang chuẩn bị video...',
      'trimming_video': 'Đang cắt video...',
      'optimizing_file': 'Đang tối ưu file...',
