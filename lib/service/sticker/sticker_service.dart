...
/// Service chịu trách nhiệm cung cấp dữ liệu sticker cho màn hình Home.
///
/// Ở đây tạm thời là dữ liệu tĩnh cấu hình từ assets.
  ...
  List<StickerPack> getAllPacks() {
    return [
      ...
      const StickerPack(
        ...
        itemCount: 17,
        isAnimated: true,
        // Tạm thời dùng tray image chung từ folder tray/
      ...
      const StickerPack(
        ...
        itemCount: 30,
        isAnimated: false, // giới hạn 30 để thoả điều kiện WhatsApp
      ),
      // ===== Baby =====
      const StickerPack(
        id: 'baby-children',
